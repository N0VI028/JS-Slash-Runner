...
- 用 512mb 的数据测试了提示词查看器, 没有卡顿
- 提示词查看器的顶部提示改为数秒后消失, 以优化移动端的使用体验
- 添加 i18n 国际化支持, 酒馆选择英文版时, 酒馆助手也将显示英文界面
...
- 补充了一些新酒馆事件的类型定义
- 播放器新增音频标题功能，可为导入的音频设置标题，方便在UI中管理

### 🗑️移除

- 移除了扩展的总开关
- 移除脚本库的`移动到另一脚本库`功能按钮，现在你可以直接将脚本拖动到另一个脚本库
- 移除播放器的冷却时间和淡入淡出功能
